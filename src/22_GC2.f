...
c       calculate local strike-normal coordinate t  
          ...
          do iGC2=1, n3-1
              call S22_GC2_tsign (iGC2, n1, iLocX, iLocY, rup_x, rup_y, 
...
c       calculate local strike-parallel coordinate u  
          ...
          do iGC2=1, n3-1
              call S22_GC2_usign (iGC2, rup_x, rup_y, uflag)             
...
c ----------------------------------------------------------------------
       ...
       subroutine S22_GC2_tsign (iGC2, n1, iLocX, iLocY, rup_x, rup_y, rup_xb, 
     1                       rup_yb, tflag)      
...
c      declarations only used within subroutine S22_      
...
c      Site is assumed to be location: (0.0, 0.0, 0.0)
       call S14_Inside_OutSide ( 4, xtestp, ytestp, 0.0, 0.0, tpositive)

c      Check to see if site is located in the t- testing area.
c      Site is assumed to be location: (0.0, 0.0, 0.0)
       call S14_Inside_OutSide ( 4, xtestn, ytestn, 0.0, 0.0, tnegative)       
...
c ----------------------------------------------------------------------
       ...
       subroutine S22_GC2_usign (iGC2, rup_x, rup_y, uflag)
...
c      Site is assumed to be location: (0.0, 0.0, 0.0)
       call S14_Inside_OutSide ( 4, xtestp, ytestp, 0.0, 0.0, upositive)

c      Check to see if site is located in the u- testing area.
c      Site is assumed to be location: (0.0, 0.0, 0.0)
       call S14_Inside_OutSide ( 4, xtestn, ytestn, 0.0, 0.0, unegative)       

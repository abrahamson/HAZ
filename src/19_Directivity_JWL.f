...
c -------------------------------------------------------------------
      subroutine S19_DirJWL_V3Uni (specT, Rrup, Rx1, Ry, Ruplen, Mag, mech, 
...
C Interpolate the coefficients for the requested spectral period.
 1020       call S24_interp (period(count1),period(count2),c8rev(count1),c8rev(count2),
     +                   specT,c8revT,iflag)
            call S24_interp (period(count1),period(count2),c8b(count1),c8b(count2),
     +                   specT,c8bT,iflag)
            call S24_interp (period(count1),period(count2),c8org(count1),c8org(count2),
     +                   specT,c8orgT,iflag)
...
c -------------------------------------------------------------------
      subroutine S19_DirJWL_V3Pre (specT, Rrup, Rx, Ry, Ruplen, Mag, mech, 
     1        RupWidth, dip, HWFlag, medadj, sigadj )
